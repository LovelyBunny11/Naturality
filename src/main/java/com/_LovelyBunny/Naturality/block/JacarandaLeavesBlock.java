...
public class JacarandaLeavesBlock extends LeavesBlock {
    public JacarandaLeavesBlock(Properties p_54422_) {
        super(p_54422_);
    }
    public void animateTick(BlockState p_272714_, Level p_272837_, BlockPos p_273218_, RandomSource p_273360_) {
        ...
        if (p_273360_.nextInt(10) == 0) {
            ...
            if (!isFaceFull($$5.getCollisionShape(p_272837_, $$4), Direction.UP)) {
                ParticleUtils.spawnParticleBelow(p_272837_, p_273218_, p_273360_, NaturalityParticleTypes.JACARANDA_LEAVES.get());
            }
        }
    }
}
