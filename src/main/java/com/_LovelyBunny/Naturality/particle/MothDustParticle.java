...
public class MothDustParticle extends TextureSheetParticle {
    ...
    public MothDustParticle(ClientLevel p_277612_, double p_278010_, double p_277614_, double p_277673_, SpriteSet p_277465_) {
        ...
        float f = this.random.nextBoolean() ? 0.005F : 0.0075F;
        this.quadSize = f;
        this.setSize(f, f);
        this.friction = 1.0F;
    }
