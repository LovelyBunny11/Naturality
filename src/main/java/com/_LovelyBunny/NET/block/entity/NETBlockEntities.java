...
public class NETBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<NETSignBlockEntity>> NET_SIGN =
            BLOCK_ENTITIES.register("mod_sign", () ->
                    BlockEntityType.Builder.of(NETSignBlockEntity::new,
                            NETBlocks.MAPLE_SIGN.get(), NETBlocks.MAPLE_WALL_SIGN.get()).build(null));

    public static final RegistryObject<BlockEntityType<NETHangingSignBlockEntity>> NET_HANGING_SIGN =
            BLOCK_ENTITIES.register("mod_hanging_sign", () ->
                    BlockEntityType.Builder.of(NETHangingSignBlockEntity::new,
                            NETBlocks.MAPLE_HANGING_SIGN.get(), NETBlocks.MAPLE_WALL_HANGING_SIGN.get()).build(null));
