    ...
    public static final RegistryObject<CreativeModeTab> NET_TAB = CREATIVE_MODE_TABS.register("net_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(NETItems.MAPLE_SAPLING.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(NETItems.LARCH_LOG.get());
                        ...
                        pOutput.accept(NETItems.LARCH_WOOD.get());
                        ...
                        pOutput.accept(NETItems.STRIPPED_LARCH_LOG.get());
                        ...
                        pOutput.accept(NETItems.STRIPPED_LARCH_WOOD.get());
                        ...
                        pOutput.accept(NETItems.LARCH_PLANKS.get());
                        ...
                        pOutput.accept(NETItems.LARCH_STAIRS.get());
                        ...
                        pOutput.accept(NETItems.LARCH_FENCE_GATE.get());
                        ...
                        pOutput.accept(NETItems.LARCH_DOOR.get());
                        ...
                        pOutput.accept(NETItems.LARCH_TRAPDOOR.get());
                        ...
                        pOutput.accept(NETItems.LARCH_PRESSURE_PLATE.get());
                        ...
                        pOutput.accept(NETItems.LARCH_BUTTON.get());
                        ...
                        pOutput.accept(NETItems.LARCH_LEAVES.get());
                        ...
                        pOutput.accept(NETItems.LARCH_SIGN.get());
                        ...
                        pOutput.accept(NETItems.LARCH_HANGING_SIGN.get());
                        ...
                        pOutput.accept(NETItems.LARCH_BOAT.get());
                        ...
                        pOutput.accept(NETItems.LARCH_CHEST_BOAT.get());
                    })
                    .build());
