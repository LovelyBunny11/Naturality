...
public class CrossTrunkPlacer extends TrunkPlacer {
    ...
    public static final Codec<CrossTrunkPlacer> CODEC;
    ...
    public CrossTrunkPlacer(int p_273281_, int p_273327_, int p_272619_, IntProvider p_272873_, IntProvider p_272789_, UniformInt p_272917_, IntProvider p_272948_) {
    ...
    protected TrunkPlacerType<?> type() {
        return NaturalityTrunkPlacers.CROSS_TRUNK_PLACER.get();
    }
    ...
    static {
        ...
        CODEC = RecordCodecBuilder.create((p_273579_) -> {
            ...
            }))).apply(p_273579_, CrossTrunkPlacer::new);
        });
    }
}
