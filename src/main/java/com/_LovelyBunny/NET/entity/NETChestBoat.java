...
public class NETChestBoat extends ChestBoat
{
    ...
    {
        this((EntityType<NETChestBoat>)NETEntities.NET_CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    protected void readAdditionalSaveData(CompoundTag nbt)
    {
        ...
        {
            this.entityData.set(DATA_ID_TYPE, NETBoat.ModelType.byName(nbt.getString("model")).ordinal());
        }
    }
    ...
    {
        switch (NETBoat.ModelType.byId(this.entityData.get(DATA_ID_TYPE)))
        {
            case MAPLE:
    ...
    public void setModel(NETBoat.ModelType type)
    {
        this.entityData.set(DATA_ID_TYPE, type.ordinal());
    }

    public NETBoat.ModelType getModel()
    {
        return NETBoat.ModelType.byId(this.entityData.get(DATA_ID_TYPE));
    }
